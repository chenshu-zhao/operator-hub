...
ALTER_TABLE_DICT = [
    ...
    ["dip_data_operator_hub", "t_op_registry",       "COLUMN",   "ADD",    "f_is_data_source",  "boolean DEFAULT 0",        "是否为数据源算子"],
    ["dip_data_operator_hub", "t_operator_release",       "COLUMN",   "ADD",    "f_is_data_source",  "boolean DEFAULT 0",        "是否为数据源算子"]
