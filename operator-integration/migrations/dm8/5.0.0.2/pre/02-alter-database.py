...
ALTER_TABLE_DICT = [
    ...
    ["dip_data_operator_hub", "t_mcp_server_config",       "COLUMN",   "ADD",     "f_creation_type",   "VARCHAR(20 CHAR) NOT NULL DEFAULT 'custom'",         "创建类型，custom:自定义mcp服务, tool_imported: 从工具箱导"],
    ["dip_data_operator_hub", "t_mcp_server_config",       "COLUMN",   "ADD",      "f_version",        "INT DEFAULT 1",            "版本号"],
    ["dip_data_operator_hub", "t_mcp_server_release",      "COLUMN",   "ADD",      "f_creation_type",   "VARCHAR(20 CHAR) NOT NULL DEFAULT 'custom'",         "创建类型，custom:自定义mcp服务, tool_imported: 从工具箱导"],
    ["dip_data_operator_hub", "t_outbox_message",       "COLUMN",   "MODIFY",   "f_topic",   "text NOT NULL",         "主题"],
    ["dip_data_operator_hub", "t_op_registry",       "COLUMN",   "ADD",    "f_is_data_source",  "TINYINT DEFAULT 0",        "是否为数据源算子"],
    ["dip_data_operator_hub", "t_operator_release",       "COLUMN",   "ADD",    "f_is_data_source",  "TINYINT DEFAULT 0",        "是否为数据源算子"]
